...
conf_train = calc_confmat(op_train,predicted,5) #confusion matrix for fine-tuning data
...
acc_pt = torch.sum(torch.diag(conf_pt)) / torch.sum(conf_pt) #accuracy for pre-training
